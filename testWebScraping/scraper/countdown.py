...
departments = ['meat-seafood', 'fruit-veg', 'fridge-deli', 'bakery', 'frozen', 'pantry', 'beer-wine', 'drinks',
...
for department in departments:
    ...
    while page <= page_num:
        response = requests.get(
            'https://shop.countdown.co.nz/api/v1/products?dasFilter=Department%3B%3B{}%3Bfalse&target=browse&page={}'.format(
                department, page), headers=headers, params=params)
...
with open('countdownData.json', 'w', encoding='utf-8') as f:
